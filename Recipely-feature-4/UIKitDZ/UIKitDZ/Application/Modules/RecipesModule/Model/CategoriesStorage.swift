...
struct CategoriesStorage {
    lazy var categories = [
        Category(
            categoryName: Local.RecipeModule.saladCategory,
            categoryImageName: Constants.categoryImageName1
        ),
        Category(
            categoryName: Local.RecipeModule.soupCategory,
            categoryImageName: Constants.categoryImageName2
        ),
        Category(
            categoryName: Local.RecipeModule.chickenCategory,
            categoryImageName: Constants.categoryImageName3
        ),
        Category(
            categoryName: Local.RecipeModule.meatCategory,
            categoryImageName: Constants.categoryImageName4
        ),
        Category(
            categoryName: Local.RecipeModule.fishCategory,
            categoryImageName: Constants.categoryImageName5
        ),
        Category(
            categoryName: Local.RecipeModule.sideDishCategory,
            categoryImageName: Constants.categoryImageName6
        ),
        Category(
            categoryName: Local.RecipeModule.drinksCategory,
            categoryImageName: Constants.categoryImageName7
        ),
        Category(
            categoryName: Local.RecipeModule.pancakeCategory,
            categoryImageName: Constants.categoryImageName8
        ),
        Category(
            categoryName: Local.RecipeModule.dessertsCategory,
