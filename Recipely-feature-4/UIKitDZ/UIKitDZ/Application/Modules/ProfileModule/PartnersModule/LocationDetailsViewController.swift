...
final class LocationDetailsViewController: UIViewController {
    ...
    var adressInfo: Location? {
        didSet {
            placeNameLabel.text = adressInfo?.title
    ...
    private func configureUI() {
        ...
        NSLayoutConstraint.activate([
            ...
            placeNameLabel.topAnchor.constraint(equalTo: view.safeAreaLayoutGuide.topAnchor, constant: 53),
            placeNameLabel.widthAnchor.constraint(equalToConstant: 350),
            placeNameLabel.heightAnchor.constraint(equalToConstant: 24),
